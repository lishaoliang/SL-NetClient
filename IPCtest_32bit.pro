...
LIBS += -L$$PWD/lib_x86/ -ll_sdk
LIBS += -L$$PWD/lib_x86/ -lavcodec
LIBS += -L$$PWD/lib_x86/ -lavdevice
LIBS += -L$$PWD/lib_x86/ -lavfilter
LIBS += -L$$PWD/lib_x86/ -lavformat
LIBS += -L$$PWD/lib_x86/ -lavutil
LIBS += -L$$PWD/lib_x86/ -lpostproc
LIBS += -L$$PWD/lib_x86/ -lswresample
LIBS += -L$$PWD/lib_x86/ -lswscale
