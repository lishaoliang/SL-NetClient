...
Component.prototype.createOperations = function()
{
    ...
    if (systemInfo.productType === "windows") {
        component.addOperation("CreateShortcut", "@TargetDir@/IPCtest_x86.exe", "@StartMenuDir@/SL Net Client.lnk",
            "workingDirectory=@TargetDir@", "iconPath=@TargetDir@/logo.ico",
            "iconId=2", "description=Open README file");
		component.addOperation("CreateShortcut", "@TargetDir@/IPCtest_x86.exe", "@HomeDir@/DeskTop/SL Net Client.lnk");
	}
}
...
Component.prototype.installerLoaded = function()
{
    ...
    targetDirectoryPage.description.setText("Please select where the SL Net Client will be installed:");
